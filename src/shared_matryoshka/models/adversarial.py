"""Adversarial baseline: gradient reversal on prefix for domain invariance."""
...
class AdversarialModel(SharedEmbeddingModel):
    """Same architecture as MatryoshkaModel.

    The domain adversarial training happens in the loss — the model itself
    is a shared encoder. The adversarial loss applies gradient reversal
    to the prefix dimensions during training.
    """
